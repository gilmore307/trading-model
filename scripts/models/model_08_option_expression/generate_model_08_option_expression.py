        ...
        rows.append(
            {
                ...
                "layer_8_underlying_handoff": underlying_plan.get("handoff_to_layer_9") or underlying_plan.get("handoff_to_layer_8", {}),
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--target-table", default="model_08_option_expression")
