...
Layer 9 no-provider case: it consumes completed Layer 7 rows and emits
...
def _layer_9_input_rows(layer_7_rows: Sequence[Mapping[str, Any]]) -> list[dict[str, Any]]:
        ...
        rows.append(
            {
                ...
                "layer_9_underlying_handoff": underlying_plan.get("handoff_to_layer_9") or underlying_plan.get("handoff_to_layer_8", {}),
    ...
    *,
    ...
    with psycopg.connect(database_url, row_factory=dict_row) as conn:
        with conn.cursor() as cursor:
            ...
            model_rows = generate_rows(_layer_9_input_rows(layer_7_rows), model_version=model_version)
