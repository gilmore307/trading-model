...
from models.model_10_event_risk_governor import MODEL_ID, MODEL_SURFACE
...
def _evaluate(model_rows: list[dict[str, Any]], *, evidence_source: str, output_json: Path | None) -> None:
    ...
    payload = evaluate_layer(
        module_name="models.model_10_event_risk_governor",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--model-table", default="model_10_event_risk_governor")
    ...
    if args.model_jsonl:
        ...
        model_rows = generate_layer("models.model_10_event_risk_governor", input_rows)
