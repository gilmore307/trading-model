    ...
    *,
    ...
    with psycopg.connect(database_url, row_factory=dict_row) as conn:
        with conn.cursor() as cursor:
            ...
            model_02_rows = _fetch_rows(cursor, schema="trading_model", table="m02_sector_context_model_generation", source_start=source_start, source_end=source_end, order_by="available_time::timestamptz ASC, sector_or_industry_symbol ASC")
            model_01_rows = _fetch_rows(cursor, schema="trading_model", table="m01_market_regime_model_generation", source_start=source_start, source_end=source_end, order_by="available_time::timestamptz ASC")
