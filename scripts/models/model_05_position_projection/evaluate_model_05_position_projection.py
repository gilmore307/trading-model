...
from models.model_05_position_projection import MODEL_ID, MODEL_SURFACE
...
def _evaluate(model_rows: list[dict[str, Any]], *, evidence_source: str, output_json: Path | None) -> None:
    ...
    payload = evaluate_layer(
        module_name="models.model_05_position_projection",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--model-table", default="model_05_position_projection")
    ...
    if args.model_jsonl:
        ...
        model_rows = generate_layer("models.model_05_position_projection", input_rows)
