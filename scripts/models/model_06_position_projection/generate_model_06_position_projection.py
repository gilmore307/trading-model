#!/usr/bin/env python3
"""Generate deterministic PositionProjectionModel rows from local JSON/JSONL inputs.
...
from models.model_06_position_projection import MODEL_ID, MODEL_SURFACE, MODEL_VERSION
