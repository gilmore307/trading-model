...
def _column_type(column: str) -> str:
    ...
    if column.startswith("6_"):
        return "TEXT" if column in {"6_dominant_projection_horizon", "6_horizon_conflict_state"} else "DOUBLE PRECISION"
    return "TEXT"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--target-table", default="model_06_position_projection")
    ...
    rows = generate_layer("models.model_06_position_projection", input_rows, model_version=args.model_version)
