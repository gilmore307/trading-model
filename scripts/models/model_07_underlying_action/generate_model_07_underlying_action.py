#!/usr/bin/env python3
"""Generate deterministic UnderlyingActionModel rows from local JSON/JSONL inputs.
...
from models.model_07_underlying_action import MODEL_ID, MODEL_SURFACE, MODEL_VERSION
