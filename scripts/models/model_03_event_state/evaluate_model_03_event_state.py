#!/usr/bin/env python3
"""Build EventStateModel labels and evaluation summary from local rows."""
...
from models.model_03_event_state import MODEL_ID, MODEL_SURFACE
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.model_jsonl:
        ...
        model_rows = generate_layer("models.model_03_event_state", input_rows)
    ...
    payload = evaluate_layer(
        module_name="models.model_03_event_state",
        label_builder_name="build_event_state_labels",
