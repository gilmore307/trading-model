#!/usr/bin/env python3
"""Build BackgroundContextModel labels and evaluation summary from local rows."""
...
from models.model_01_background_context import MODEL_ID, MODEL_SURFACE
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.model_jsonl:
        ...
        model_rows = generate_layer("models.model_01_background_context", input_rows)
    ...
    payload = evaluate_layer(
        module_name="models.model_01_background_context",
        label_builder_name="build_background_context_labels",
