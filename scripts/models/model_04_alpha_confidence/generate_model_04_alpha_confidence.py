...
from models.model_04_alpha_confidence import MODEL_ID, MODEL_SURFACE, MODEL_VERSION, generate_rows
...
def _quality_payload(*, market: Mapping[str, Any], sector: Mapping[str, Any], target: Mapping[str, Any], event: Mapping[str, Any]) -> dict[str, Any]:
    data_quality = min(
        ...
        _safe_score(event.get("8_event_context_quality_score_390min"), 0.75),
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--target-table", default="model_04_alpha_confidence")
    ...
    rows = generate_layer("models.model_04_alpha_confidence", input_rows, model_version=args.model_version)
