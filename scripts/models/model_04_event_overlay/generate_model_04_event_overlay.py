#!/usr/bin/env python3
"""Generate deterministic EventOverlayModel rows from local JSON/JSONL inputs.
...
from models.model_04_event_overlay import MODEL_ID, MODEL_SURFACE, MODEL_VERSION
