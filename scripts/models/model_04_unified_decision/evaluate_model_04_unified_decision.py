#!/usr/bin/env python3
"""Build UnifiedDecisionModel labels and evaluation summary from local rows."""
...
from models.model_04_unified_decision import MODEL_ID, MODEL_SURFACE
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.model_jsonl:
        ...
        model_rows = generate_layer("models.model_04_unified_decision", input_rows)
    ...
    payload = evaluate_layer(
        module_name="models.model_04_unified_decision",
        label_builder_name="build_unified_decision_labels",
