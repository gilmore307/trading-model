#!/usr/bin/env python3
"""Conservative UnifiedDecisionModel local promotion-review wrapper.

The wrapper reviews a local evaluation summary and always refuses activation.
Production approval remains gated by real point-in-time labels, replay metrics,
baselines, stability, leakage checks, and explicit manager-side review.
"""
