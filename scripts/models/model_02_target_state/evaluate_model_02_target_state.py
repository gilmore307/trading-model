#!/usr/bin/env python3
"""Build TargetStateModel labels and evaluation summary from local rows."""
...
from models.model_02_target_state import MODEL_ID, MODEL_SURFACE
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.model_jsonl:
        ...
        model_rows = generate_layer("models.model_02_target_state", input_rows)
    ...
    payload = evaluate_layer(
        module_name="models.model_02_target_state",
        label_builder_name="build_target_state_labels",
