...
LAYER_ACCEPTANCES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "required_next_steps": [
            "Create point-in-time EventFailureRiskModel evaluation rows from reviewed event-family and strategy-failure evidence.",
            "Generate calibrated strategy-failure, entry-block, exposure-cap, and path-risk labels by horizon.",
            "Run baseline, stability, leakage, calibration, and promotion-metric evaluation before re-review.",
        ],
    },
    {
