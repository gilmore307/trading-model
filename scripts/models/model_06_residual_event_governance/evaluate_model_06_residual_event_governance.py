#!/usr/bin/env python3
"""Build ResidualEventGovernanceModel labels and evaluation summary from local rows."""
...
from models.model_06_residual_event_governance import MODEL_ID, MODEL_SURFACE
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.model_jsonl:
        ...
        model_rows = generate_layer("models.model_06_residual_event_governance", input_rows)
    ...
    payload = evaluate_layer(
        module_name="models.model_06_residual_event_governance",
        label_builder_name="build_residual_event_governance_labels",
