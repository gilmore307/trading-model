...
- `ensure_model_governance_schema.py` creates the generic `trading_model` governance/evaluation tables through `psql`. Use `--dry-run` to print DDL without touching PostgreSQL.
