...
- `models/review_layers_03_08_promotion_acceptance.py` emits explicit deferred/blocked promotion evidence artifacts for layers that lack production evaluation substrate. It must not activate configs or persist manager-control-plane decisions.
