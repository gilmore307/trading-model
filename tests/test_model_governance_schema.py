...
class ModelGovernanceSchemaTests(unittest.TestCase):
    def test_governance_schema_creates_evidence_tables_in_dependency_order(self) -> None:
    ...
    def test_manager_owned_promotion_control_plane_tables_are_not_model_schema(self) -> None:
        ...
        self.assertNotIn('CREATE TABLE IF NOT EXISTS "trading_model"."model_promotion_candidate"', joined)
        self.assertNotIn('CREATE TABLE IF NOT EXISTS "trading_model"."model_promotion_decision"', joined)
        self.assertNotIn('CREATE TABLE IF NOT EXISTS "trading_model"."model_promotion_activation"', joined)
        self.assertNotIn('CREATE TABLE IF NOT EXISTS "trading_model"."model_promotion_rollback"', joined)
    ...
    def test_json_payload_columns_are_jsonb_not_text_blobs(self) -> None:
        ...
        for manager_column in [
            ...
            self.assertNotIn(f'"{manager_column}" JSONB NOT NULL DEFAULT', joined)
