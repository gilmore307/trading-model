...
from models.model_10_event_risk_governor.event_model_acceptance import build_event_model_acceptance_report, write_report_file
...
class EventModelAcceptanceTests(unittest.TestCase):
    def test_acceptance_accepts_risk_governor_and_blocks_alpha_activation(self) -> None:
        ...
        self.assertIn("source_10_event_risk_governor", governor["next_evidence_gate"])
        ...
        self.assertIn("source_10_event_risk_governor", row["downstream_regeneration_policy"])
