...
class EventModelAcceptanceTests(unittest.TestCase):
    def test_acceptance_accepts_risk_governor_and_blocks_alpha_activation(self) -> None:
        ...
        self.assertIn("model_06_residual_event_governance_data_acquisition", governor["next_evidence_gate"])
        self.assertIn("model_06_residual_event_governance_feature_generation", governor["next_evidence_gate"])
        ...
        self.assertIn("model_06_residual_event_governance_data_acquisition", row["downstream_regeneration_policy"])
        self.assertIn("model_06_residual_event_governance_feature_generation", row["downstream_regeneration_policy"])
