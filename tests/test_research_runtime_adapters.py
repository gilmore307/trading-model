...
def test_regime_local_artifact_adapter_produces_snapshot_row():
    row = {
        ...
        'feature_snapshot': {
            ...
            'primary_15m': {'regime': 'trend', 'confidence': 0.9, 'scores': {'trend': 0.9}, 'tradable': True, 'adx': 80.0, 'last_price': 101000.0, 'vwap_deviation_z': -2.0, 'bollinger_bandwidth_pct': 0.02, 'realized_vol_pct': 0.5, 'funding_pctile': 0.6, 'oi_accel': -0.2, 'basis_deviation_pct': -0.001},
    ...
    assert adapted['primary_features']['last_price'] == 101000.0
