...
class StateVectorFeatureRegistryTests(unittest.TestCase):
    def test_feature_semantics_are_explicit_and_valid(self) -> None:
        ...
        self.assertEqual(by_field["7_cost_to_adjust_position_score_<horizon>"].high_value_meaning, "bad")
        self.assertEqual(by_field["8_underlying_action_direction_score_<horizon>"].high_value_meaning, "signed")
