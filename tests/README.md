...
- `test_realtime_decision_handoff.py` covers `execution_model_decision_input_snapshot` validation and C-runtime-component-routed `model_realtime_decision_route_plan` fixture/shadow routing without model activation.
