...
- `test_realtime_decision_handoff.py` covers `execution_model_decision_input_snapshot_v1` validation and `model_realtime_decision_route_plan_v1` fixture/shadow routing without model activation.
