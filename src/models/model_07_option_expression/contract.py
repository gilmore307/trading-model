"""Current physical constants for Layer 7 OptionExpressionModel."""
from __future__ import annotations

from typing import Final

MODEL_ID: Final[str] = "option_expression_model"
MODEL_LAYER: Final[str] = "layer_07_option_expression"  # current conceptual layer token
MODEL_SURFACE: Final[str] = "model_07_option_expression"
