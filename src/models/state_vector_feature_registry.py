...
STATE_VECTOR_FEATURE_SEMANTICS: Final[tuple[FeatureSemantics, ...]] = (
    ...
    FeatureSemantics("9_option_expression_eligibility_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Option-expression admissibility after Layer 7 thesis, policy, option-chain, liquidity, IV, and risk constraints; not order approval."),
    ...
    FeatureSemantics("9_option_greek_fit_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Delta/Greek fit for expressing the Layer 7 underlying path thesis without crossing into execution."),
