...
STATE_VECTOR_FEATURE_SEMANTICS: Final[tuple[FeatureSemantics, ...]] = (
    ...
    FeatureSemantics("7_risk_budget_fit_score_<horizon>", "layer_07_position_projection", "float", "[0, 1]", "quality", "good", "model_facing", "Compatibility with current risk budget and portfolio constraints."),
    ...
    FeatureSemantics("7_projection_confidence_score_<horizon>", "layer_07_position_projection", "float", "[0, 1]", "quality", "good", "model_facing", "Confidence in the Layer 6 alpha-to-position mapping; separate from Layer 5 alpha confidence."),
    ...
    FeatureSemantics("8_underlying_holding_time_fit_score_<horizon>", "layer_08_underlying_action", "float", "[0, 1]", "quality", "good", "model_facing", "Compatibility between planned holding time and alpha/projection/path evidence."),
    ...
    FeatureSemantics("9_option_contract_fit_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Overall fit of selected option contract candidate to Layer 7 path thesis and option-expression constraints."),
