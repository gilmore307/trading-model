...
STATE_VECTOR_FEATURE_SEMANTICS: Final[tuple[FeatureSemantics, ...]] = (
    ...
    FeatureSemantics("4_event_response_strength_score_<horizon>", "layer_04_event_failure_risk", "float", "[0, 1]", "response", "magnitude", "model_facing", "Layer 4 quantitative response magnitude learned from frozen Layer 10 event contracts; not standalone event alpha."),
    FeatureSemantics("4_event_response_direction_score_<horizon>", "layer_04_event_failure_risk", "float", "[-1, 1]", "response", "signed", "model_facing", "Layer 4 conditional response tendency from frozen Layer 10 event contracts; Layer 5 owns adjusted after-cost alpha."),
    FeatureSemantics("4_event_response_uncertainty_score_<horizon>", "layer_04_event_failure_risk", "float", "[0, 1]", "risk", "bad", "model_facing", "Uncertainty around the event-conditioned response inside the Layer 10-approved window."),
    ...
    FeatureSemantics("10_event_presence_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "intensity", "count", "model_facing", "Visible event presence by horizon; high means more event presence, not good/bad by itself."),
    FeatureSemantics("10_event_timing_proximity_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "intensity", "count", "model_facing", "Proximity to a sensitive event window; high means more immediate event pressure, not good/bad by itself."),
    FeatureSemantics("10_event_intensity_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "intensity", "count", "model_facing", "Information shock / attention intensity; high means stronger visible event pressure, not good/bad by itself."),
    FeatureSemantics("10_event_direction_bias_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed target-conditioned event bias; not alpha confidence."),
    FeatureSemantics("10_event_context_alignment_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed support/conflict between event evidence and current target context."),
    FeatureSemantics("10_event_uncertainty_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "risk", "bad", "model_facing", "Information uncertainty; high is worse."),
    FeatureSemantics("10_event_gap_risk_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "risk", "bad", "model_facing", "Jump/gap risk; high is worse."),
    FeatureSemantics("10_event_reversal_risk_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "risk", "bad", "model_facing", "Current-path reversal risk; high is worse."),
    FeatureSemantics("10_event_liquidity_disruption_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "liquidity", "bad", "model_facing", "Spread/depth/slippage disruption risk; high is worse."),
    FeatureSemantics("10_event_contagion_risk_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "risk", "bad", "model_facing", "Cross-scope transmission risk; high is worse."),
    FeatureSemantics("10_event_context_quality_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "quality", "good", "model_facing", "Event evidence quality and context completeness."),
    FeatureSemantics("10_event_market_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed market-scope event impact."),
    FeatureSemantics("10_event_sector_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed sector-scope event impact."),
    FeatureSemantics("10_event_industry_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed industry-scope event impact."),
    FeatureSemantics("10_event_theme_factor_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed theme/factor-scope event impact."),
    FeatureSemantics("10_event_peer_group_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed peer-group event impact."),
    FeatureSemantics("10_event_symbol_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed symbol-scope event impact; not ticker identity memorization."),
    FeatureSemantics("10_event_microstructure_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed microstructure-scope event impact."),
    FeatureSemantics("10_event_underlying_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed event impact on the direct underlying thesis; not alpha confidence or trade action."),
    FeatureSemantics("10_event_option_impact_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "risk", "bad", "model_facing", "Option-surface event sensitivity such as IV/gamma/pin/flow risk; not contract selection."),
    FeatureSemantics("10_event_scope_confidence_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "quality", "good", "model_facing", "Confidence in assigned event impact scope."),
    FeatureSemantics("10_event_scope_escalation_risk_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "risk", "bad", "model_facing", "Risk that event impact spreads beyond current scope; high is worse."),
    FeatureSemantics("10_event_target_relevance_score_<horizon>", "layer_10_event_risk_governor", "float", "[0, 1]", "quality", "good", "model_facing", "Relevance of visible event evidence to the target context."),
    ...
    FeatureSemantics("9_option_expression_eligibility_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Option-expression admissibility after Layer 8 thesis, policy, option-chain, liquidity, IV, and risk constraints; not order approval."),
    FeatureSemantics("9_option_expression_direction_score_<horizon>", "layer_09_option_expression", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed option-expression direction; positive call-side/bullish, negative put-side/bearish, near zero no-option expression."),
    FeatureSemantics("9_option_contract_fit_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Overall fit of selected option contract candidate to Layer 8 path thesis and option-expression constraints."),
    FeatureSemantics("9_option_liquidity_fit_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "liquidity", "good", "model_facing", "Option bid/ask, volume, and open-interest fit; high is more liquid/fillable under conservative assumptions."),
    FeatureSemantics("9_option_iv_fit_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Implied-volatility and IV-rank fit for the selected expression; high means IV is acceptable for premium risk."),
    FeatureSemantics("9_option_greek_fit_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Delta/Greek fit for expressing the Layer 8 underlying path thesis without crossing into execution."),
    FeatureSemantics("9_option_reward_risk_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Premium-adjusted reward/risk quality for the offline option expression."),
    FeatureSemantics("9_option_theta_risk_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "risk", "bad", "model_facing", "Theta-decay pressure for the option expression; high is worse."),
    FeatureSemantics("9_option_fill_quality_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Conservative fill-quality estimate from spread/liquidity evidence; not a route or order type."),
    FeatureSemantics("9_option_expression_confidence_score_<horizon>", "layer_09_option_expression", "float", "[0, 1]", "quality", "good", "model_facing", "Calibrated confidence in the offline option-expression plan; not final approval or execution authorization."),
)
