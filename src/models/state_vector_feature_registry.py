...
STATE_VECTOR_FEATURE_SEMANTICS: Final[tuple[FeatureSemantics, ...]] = (
    ...
    FeatureSemantics("4_event_presence_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "intensity", "count", "model_facing", "Visible event presence by horizon; high means more event presence, not good/bad by itself."),
    FeatureSemantics("4_event_timing_proximity_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "intensity", "count", "model_facing", "Proximity to a sensitive event window; high means more immediate event pressure, not good/bad by itself."),
    FeatureSemantics("4_event_intensity_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "intensity", "count", "model_facing", "Information shock / attention intensity; high means stronger visible event pressure, not good/bad by itself."),
    FeatureSemantics("4_event_direction_bias_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed target-conditioned event bias; not alpha confidence."),
    FeatureSemantics("4_event_context_alignment_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed support/conflict between event evidence and current target context."),
    FeatureSemantics("4_event_uncertainty_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "risk", "bad", "model_facing", "Information uncertainty; high is worse."),
    FeatureSemantics("4_event_gap_risk_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "risk", "bad", "model_facing", "Jump/gap risk; high is worse."),
    FeatureSemantics("4_event_reversal_risk_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "risk", "bad", "model_facing", "Current-path reversal risk; high is worse."),
    FeatureSemantics("4_event_liquidity_disruption_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "liquidity", "bad", "model_facing", "Spread/depth/slippage disruption risk; high is worse."),
    FeatureSemantics("4_event_contagion_risk_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "risk", "bad", "model_facing", "Cross-scope transmission risk; high is worse."),
    FeatureSemantics("4_event_context_quality_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "quality", "good", "model_facing", "Event evidence quality and context completeness."),
    FeatureSemantics("4_event_market_impact_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed market-scope event impact."),
    FeatureSemantics("4_event_sector_impact_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed sector-scope event impact."),
    FeatureSemantics("4_event_industry_impact_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed industry-scope event impact."),
    FeatureSemantics("4_event_theme_factor_impact_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed theme/factor-scope event impact."),
    FeatureSemantics("4_event_peer_group_impact_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed peer-group event impact."),
    FeatureSemantics("4_event_symbol_impact_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed symbol-scope event impact; not ticker identity memorization."),
    FeatureSemantics("4_event_microstructure_impact_score_<horizon>", "layer_04_event_overlay", "float", "[-1, 1]", "direction", "signed", "model_facing", "Signed microstructure-scope event impact."),
    FeatureSemantics("4_event_scope_confidence_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "quality", "good", "model_facing", "Confidence in assigned event impact scope."),
    FeatureSemantics("4_event_scope_escalation_risk_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "risk", "bad", "model_facing", "Risk that event impact spreads beyond current scope; high is worse."),
    FeatureSemantics("4_event_target_relevance_score_<horizon>", "layer_04_event_overlay", "float", "[0, 1]", "quality", "good", "model_facing", "Relevance of visible event evidence to the target context."),
