...
STATE_VECTOR_FEATURE_SEMANTICS: Final[tuple[FeatureSemantics, ...]] = (
    ...
    FeatureSemantics("4_event_session_gap_risk_score_<horizon>", "layer_04_event_failure_risk", "float", "[0, 1]", "risk", "bad", "model_facing", "Reviewed event-amplified overnight, weekend, holiday, halt, or other non-continuous-market holding risk; high is worse."),
