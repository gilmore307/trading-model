...
- `families/` — importable numbered per-family strategy specs; `family_00_common.py` owns shared primitives and `family_01_*` through `family_10_*` follow first evaluation order, with deterministic variant expansion and stable spec hashes.
