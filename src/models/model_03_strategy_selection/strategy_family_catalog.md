...
|---|---|---|---:|---|
| `moving_average_crossover` | Follow trend changes when a faster moving average crosses a slower one. | Unified 1-minute bars; sparse MA profiles cover micro through long day-level horizons; market/sector context affects strategy selection outside the family. | 108 | `equity_bar` |
...
| Axis | Values | Count |
|---|---|---:|
| `ma_window_profile` | `micro_3_10`, `scalp_5_20`, `fast_10_30`, `intraday_30_120`, `intraday_60_240`, `intraday_120_480`, `intraday_240_960`, `equity_day_390_1950`, `continuous_day_1440_7200` | 9 |
| `ma_type` | `sma`, `ema` | 2 |
| `crossover_confirmation_bars` | `1`, `2`, `3` | 3 |
| `min_slope` | `0`, `0.05` | 2 |
Variant count: `9 * 2 * 3 * 2 = 108`.
...
- Fast profiles cover crypto and near-zero-slippage high-volume options; intraday profiles cover stock day-trading; the longest initial profile preserves a long day-level right endpoint so later reviews can insert intermediate windows between accepted endpoints.
