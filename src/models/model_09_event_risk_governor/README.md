...
- `residual_anomaly_event_discovery.py` emits `residual_anomaly_event_discovery`, starting from `base_stack_layers_01_08` evaluation residuals and searching PIT event families for explanations, observation-pool candidates, and strategy-promotion review packets.
