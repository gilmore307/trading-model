...
LAYER_CONTRACT_DOC = "trading-model/docs/18_layer_09_event_risk_governor.md"
...
def build_event_model_acceptance_report(*, generated_at_utc: str | None = None) -> EventModelAcceptanceReport:
    ...
    return EventModelAcceptanceReport(
        ...
        actionable_judgment=(
            "Close the event-model redo as Layer 9 EventRiskGovernor / EventIntelligenceOverlay: "
