...
MODEL_VERSION: Final[str] = "expression_probability_surface_contract"
EXPRESSION_PROBABILITY_SURFACE_OUTPUT: Final[str] = "expression_probability_surface"
CONCEPTUAL_OUTPUT: Final[str] = EXPRESSION_PROBABILITY_SURFACE_OUTPUT
PRIMARY_OUTPUT: Final[str] = EXPRESSION_PROBABILITY_SURFACE_OUTPUT
