...
def run_guidance_interpretation_review(inputs: GuidanceInterpretationReviewInputs) -> dict[str, Any]:
    ...
    report = {
        ...
        "interpretation": [
            ...
            "M03 event-state governance consumption remains direction-neutral context only unless a later reviewed policy explicitly accepts stronger effect-model evidence.",
        ],
    }
