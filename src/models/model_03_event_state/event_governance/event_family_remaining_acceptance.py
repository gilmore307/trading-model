...
def _disposition(spec: Mapping[str, Any]) -> tuple[str, str, str, str, tuple[str, ...], str, str]:
    ...
    if family == "cpi_inflation_release":
        return (
            ...
            "Keep CPI surprise as macro event-risk-shape feature; build fuller TE expectation-history route before production canonicalization.",
...
The acceptance summary separates risk-shape candidates from blocked packet work and deferred low-signal families. No family is promoted to standalone directional alpha.
""",
        encoding="utf-8",
    )
