"""Residual-anomaly to event-family discovery for M03 event-state governance tooling.
...
from models.model_03_event_state.event_governance.price_anomaly_event_discovery import _event_family_dates, _nearby, _parse_dt
...
class ResidualAnomalyEventDiscovery:
    ...
    def summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "discovery_note": "Starts from base_stack_layers_01_09 evaluation residuals, then searches nearby PIT event families. Promotion requires an evidence packet plus agent review.",
        }
...
This artifact starts from `base_stack_layers_01_09` evaluation residuals, not raw price anomalies. It then searches nearby point-in-time event families for explanations, observation-pool candidates, and strategy-promotion review packets. Strategy promotion remains blocked until an emitted packet receives agent review.
