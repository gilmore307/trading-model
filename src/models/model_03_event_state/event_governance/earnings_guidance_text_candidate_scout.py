...
Conclusion: this artifact narrows the next review queue but does not create signed earnings/guidance claims. Candidate spans require reviewed interpretation and point-in-time expectation baselines before promotion or M03 event-state governance escalation.
""",
        encoding="utf-8",
    )
    return report
