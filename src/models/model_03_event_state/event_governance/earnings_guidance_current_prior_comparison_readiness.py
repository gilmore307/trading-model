...
or M03 event-state governance escalation.
"""
...
def run_current_prior_comparison_readiness(inputs: CurrentPriorComparisonReadinessInputs) -> dict[str, Any]:
    ...
    report = {
        ...
        "interpretation": [
            ...
            "Current-vs-prior raise/cut, guidance surprise, beat/miss, signed alpha, model activation, and stronger M03 event-state effect-model evidence remain blocked.",
