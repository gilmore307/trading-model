"""Fine-grained event-family batch catalog for M03 event-state governance association work.
...
FAMILY_SPECS: tuple[_FamilySpec, ...] = (
    _FamilySpec(
        ...
        "signed_alpha_or_stronger_effect_model",
    ...
    _FamilySpec(
        ...
        "signed_guidance_alpha_or_event_effect_model",
    ...
    _FamilySpec(
        ...
        (_trading_data_ref("storage/monthly_backfill/sec_company_financials/2016-01/completion_receipt.json"),),
    ...
    _FamilySpec(
        ...
        (_trading_data_ref("storage/monthly_backfill/alpaca_news/2016-01/completion_receipt.json"),),
    ...
    _FamilySpec(
        ...
        (_trading_data_ref("storage/monthly_backfill/gdelt_news/2016-01/completion_receipt.json"),),
...
def build_event_family_batch_catalog(*, root: Path = Path("."), generated_at_utc: str | None = None) -> EventFamilyBatchCatalog:
    ...
    return EventFamilyBatchCatalog(
        ...
        granularity_rule=(
            ...
            "price/path association study before model training, risk control promotion, or alpha claims."
        ),
