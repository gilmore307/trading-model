"""Scan local empirical coverage for all M03 event-state governance event families.
...
This artifact scans only existing local source/study artifacts for all {len(coverage.family_rows)} M03 event-state governance families.
