"""Event observation-pool and promotion policy for M03 event-state governance.
...
def build_event_observation_pool_policy(*, generated_at_utc: str | None = None) -> EventObservationPoolPolicy:
    ...
    observation_rows = (
        ObservationPoolRow(
            ...
            note="Accepted for event-risk-shape observation, not standalone alpha.",
        ),
        ObservationPoolRow(
        ...
        ObservationPoolRow(
            ...
            promotion_status="not_strategy_promotion_currently",
            agent_review_required=True,
            note="Reverse-discovery candidate; not accepted for component control until canonical event interpretation and matched controls pass.",
        ),
    )
    promotion_rules = (
        PromotionRuleRow(
        ...
        PromotionRuleRow(
            ...
            allowed_result="event may be monitored for effect-model evidence",
            agent_review_required=True,
        ),
        PromotionRuleRow(
