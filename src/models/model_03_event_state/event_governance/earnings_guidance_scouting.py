...
training data activation, or an event-risk control.
"""
...
def run_study(inputs: StudyInputs) -> dict[str, Any]:
    ...
    report = {
        ...
        "interpretation": [
            ...
            "The canonical earnings-shell slice is useful as an event-family scout but remains far below coverage gates and cannot promote M03 event-state governance behavior.",
