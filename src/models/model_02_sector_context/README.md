...
- Planned physical artifacts: `trading_model.model_02_sector_context`, `trading_model.model_02_sector_context_explainability`, and `trading_model.model_02_sector_context_diagnostics`.
