...
This artifact validates the M06 event-family impact-parameter contract. It enumerates candidate windows and selects the highest event-vs-control risk-delta window for CPI-style scheduled data releases, triple-witching-style scheduled calendar events, and breaking-news-style unscheduled shocks.
