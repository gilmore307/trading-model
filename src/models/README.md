...
- `model_08_event_risk_governor/` — Layer 8 deterministic scaffold for `EventRiskGovernor`, producing point-in-time `event_context_vector` rows and offline event-overlay labels without alpha/action leakage.
