"""Local evaluation-label helpers for Layer 8 UnderlyingActionModel.
...
def build_plan_quality_labels(
    ...
    for plan in plan_rows:
        ...
        action_type = str(plan_payload.get("planned_underlying_action_type") or plan.get("8_resolved_underlying_action_type") or "")
