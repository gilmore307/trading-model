...
def build_event_model_acceptance_report(*, generated_at_utc: str | None = None) -> EventModelAcceptanceReport:
    ...
    return EventModelAcceptanceReport(
        ...
        actionable_judgment=(
            "Close the event-model redo as Layer 10 EventRiskGovernor / EventIntelligenceOverlay: "
        ...
        family_statuses=(
            ...
            EventFamilyAcceptanceStatus(
                ...
                next_evidence_gate="rebuild_m06_residual_event_governance_data_acquisition_m06_residual_event_governance_feature_generation_model_10_event_risk_governor_over_reviewed_event_feeds_then_evaluate_without_activation",
            ),
        ),
        ...
        required_next_actions=(
            ...
            "generate_m06_residual_event_governance_feature_generation_and_model_10_event_risk_governor_outputs",
