...
- `event_family_impact_window_replay.py` applies the reviewed impact-window parameters to frozen replay decision rows and emits Layer 10 replay overlay evidence without changing replay, SQL, model activation, broker, or account state.
