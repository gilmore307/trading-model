"""Fold-scoped Layer 10 event-family completion evidence.
...
CONTRACT_TYPE = "layer_10_fold_completion"
SUMMARY_CONTRACT_TYPE = "layer_10_fold_completion_summary"

DEFAULT_FOLD_ID = "fold_2016-01_2016-06"
DEFAULT_REPLAY_RUN_ID = "model_group_replay_20260609T060059Z"
DEFAULT_OUTPUT_DIR = model_storage_root() / "layer_10_fold_completion_20260610" / DEFAULT_FOLD_ID / DEFAULT_REPLAY_RUN_ID
...
def build_layer_10_fold_completion(
    *,
...
def write_layer_10_fold_completion_artifacts(completion: Layer10FoldCompletion, output_dir: Path) -> None:
    output_dir.mkdir(parents=True, exist_ok=True)
    (output_dir / "layer_10_fold_completion.json").write_text(
        json.dumps(completion.to_dict(), indent=2, sort_keys=True) + "\n", encoding="utf-8"
    )
    (output_dir / "layer_10_fold_completion_summary.json").write_text(
...
def write_completion(completion: Layer10FoldCompletion, *, output: TextIO) -> None:
