...
- `model_governance/` owns reusable SQL helpers for generic dataset request, snapshot, split, label, evaluation run, metric, config version, promotion candidate, promotion decision, and rollback tables.
