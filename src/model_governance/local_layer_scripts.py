    ...
    "model_06_dynamic_risk_policy": [
        {
            ...
            "alpha_confidence_vector": {"5_alpha_confidence_score_390min": 0.90, "5_path_quality_score_390min": 0.80},
    ...
    "model_08_underlying_action": [
        {
            ...
            "position_projection_vector": {"7_dominant_projection_horizon": "390min", "7_target_exposure_score_390min": 0.40, "7_projection_confidence_score_390min": 0.92, "7_risk_budget_fit_score_390min": 0.95, "7_cost_to_adjust_position_score_390min": 0.08, "7_position_state_stability_score_390min": 0.90},
...
FIXTURE_OUTCOME_ROWS: dict[str, list[dict[str, Any]]] = {
    ...
    "model_10_event_risk_governor": [{"event_context_vector_ref": "ecv_3a5b6bb6c3a72d97", "realized_symbol_move_after_event_390min": -0.04}],
    ...
    "model_06_dynamic_risk_policy": [{"dynamic_risk_policy_state_ref": "drp_9820f47a50d7bf25", "realized_premium_efficiency_390min": 0.34, "realized_risk_budget_efficiency_390min": 0.62, "realized_policy_breach_390min": False}],
    "model_07_position_projection": [{"position_projection_vector_ref": "ppv_f154b03e7648d661", "realized_position_utility_390min": 0.12, "realized_risk_budget_breach_390min": False}],
...
def fixture_outcome_rows(model_surface: str, model_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for row in model_rows:
        if model_surface == "model_04_event_failure_risk":
            ...
            rows.append({"dynamic_risk_policy_state_ref": row.get("dynamic_risk_policy_state_ref"), "realized_premium_efficiency_390min": 0.34, "realized_risk_budget_efficiency_390min": 0.62, "realized_policy_breach_390min": False})
