"""Shared local CLI helpers for deterministic Layers 4-8 scripts.
    ...
    "model_05_position_projection": [
        {
            ...
            "alpha_confidence_vector": {"4_alpha_direction_score_390min": 0.80, "4_alpha_strength_score_390min": 0.70, "4_expected_return_score_390min": 0.06, "4_alpha_confidence_score_390min": 0.90, "4_signal_reliability_score_390min": 0.85, "4_path_quality_score_390min": 0.80, "4_reversal_risk_score_390min": 0.15, "4_drawdown_risk_score_390min": 0.20, "4_alpha_tradability_score_390min": 0.90},
    ...
    "model_06_underlying_action": [
        {
            ...
            "alpha_confidence_vector": {"4_alpha_confidence_score_390min": 0.90, "4_expected_return_score_390min": 0.05, "4_path_quality_score_390min": 0.85, "4_reversal_risk_score_390min": 0.10, "4_drawdown_risk_score_390min": 0.20},
            "position_projection_vector": {"5_dominant_projection_horizon": "390min", "5_target_exposure_score_390min": 0.40, "5_projection_confidence_score_390min": 0.92, "5_risk_budget_fit_score_390min": 0.95, "5_cost_to_adjust_position_score_390min": 0.08, "5_position_state_stability_score_390min": 0.90},
...
FIXTURE_OUTCOME_ROWS: dict[str, list[dict[str, Any]]] = {
    ...
    "model_04_alpha_confidence": [{"alpha_confidence_vector_ref": "acv_7d1d9b0867ac4d13", "forward_return_390min": -0.05, "idiosyncratic_residual_return_390min": -0.04, "alpha_tradable_label_390min": True}],
    "model_05_position_projection": [{"position_projection_vector_ref": "ppv_f154b03e7648d661", "realized_position_utility_390min": 0.12, "realized_risk_budget_breach_390min": False}],
    "model_06_underlying_action": [{"underlying_action_plan_ref": "uap_7c6b5381d428ea0a", "entry_price_hit": True, "realized_underlying_return": 0.04, "slippage_pct": 0.001, "spread_cost_pct": 0.001}],
    "model_07_option_expression": [{"option_expression_plan_ref": "oep_8b65e90b82a73385", "realized_option_return_390min": 0.42, "target_premium_hit_before_stop_label_390min": True}],
}
...
def fixture_outcome_rows(model_surface: str, model_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for row in model_rows:
        ...
        elif model_surface == "model_04_alpha_confidence":
        ...
        elif model_surface == "model_05_position_projection":
        ...
        elif model_surface == "model_06_underlying_action":
        ...
        elif model_surface == "model_07_option_expression":
