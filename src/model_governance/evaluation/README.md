...
It does not own model activation, rollback, human/agent promotion decisions, or production pointers. Those lifecycle concerns belong in `model_governance/promotion/`.
