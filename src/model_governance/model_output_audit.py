...
MODEL_OUTPUT_TABLES: tuple[str, ...] = (
    ...
    "model_06_position_projection_explainability",
    "model_06_position_projection_diagnostics",
    "model_07_underlying_action",
    "model_07_underlying_action_explainability",
    "model_07_underlying_action_diagnostics",
    "model_08_option_expression",
    "model_08_option_expression_explainability",
    "model_08_option_expression_diagnostics",
    "model_09_event_risk_governor",
    "model_09_event_risk_governor_explainability",
    "model_09_event_risk_governor_diagnostics",
)
