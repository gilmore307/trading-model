...
def build_market_regime_promotion_prompt(
    *,
    ...
    return (
        ...
        "explicit acceptance thresholds, passing threshold_results, baseline comparison, split/refit-stability evidence, "
        "and no unresolved data-leakage or cleanup blocker.\n"
...
def build_sector_context_promotion_prompt(
    *,
    ...
    return (
        ...
        "passing threshold_results, baseline comparison, split/refit-stability evidence, selected/watch/blocked direction-neutral handoff quality, "
        "long-bias and short-bias evidence that does not treat stable downtrends as failed states, "
