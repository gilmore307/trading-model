...
- `93_state_vector_feature_registry.md` — accepted semantic guardrails for Layer 1/2/3 state-vector, Layer 4 event-context, Layer 5 alpha-confidence, Layer 6 position-projection, and Layer 7 underlying-action score direction, quality, risk, scope, liquidity, routing, diagnostics, and research-only fields.
