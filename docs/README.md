...
- `04_layer_03_target_state_vector.md` — accepted Layer 3 target state-vector contract, deterministic scaffold status, market/sector/target feature blocks, labels, diagnostics, and acceptance gates.
