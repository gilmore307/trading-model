...
- [100_event_family_scouting.md](100_event_family_scouting.md) — Layer 8 event-family scouting contract, fine-grained family batch catalog, status values, early-stop rules, and current option/news amplifier findings.
