...
- `96_promotion_closeout.md` — current production-promotion closeout receipt: persisted real-evidence deferred decisions for Layers 1-2 and explicit production-evidence blockers for Layers 3-8.
