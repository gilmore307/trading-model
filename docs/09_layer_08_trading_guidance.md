...
Status: active architecture revision. Conceptual Layer 8; current V1 physical implementation surface remains `src/models/model_07_option_expression/` as the option-expression subset until a dedicated TradingGuidanceModel migration is implemented.
