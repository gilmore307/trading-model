...
Layer 8 is optional expression context. Crypto/direct-underlying-only routes may bypass option-expression planning, while Layer 9 event-risk governance still uses the Layer 7 thesis as its canonical intervention target.
<!-- /ACTIVE_LAYER_REVISION -->
