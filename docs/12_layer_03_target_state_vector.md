...
- Layer 5 AlphaConfidenceModel and later consumers, not Layer 3, own direction-confidence calibration, target/stop/action projection, position sizing, expression, and final trading guidance. Layer 8 EventRiskGovernor owns post-guidance event-risk intervention.
