...
- Underlying-action modeling for offline direct underlying/spot action thesis across stock, ETF, or crypto-style candidates, planned exposure change, price-path assumptions, and optional Layer 8 handoff; this is not broker/exchange execution.
