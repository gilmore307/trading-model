...
Status: active Layer 8 EventRiskGovernor research/governance contract.
...
```bash
PYTHONPATH=src python3 scripts/models/model_08_event_risk_governor/build_event_family_remaining_acceptance.py
```
