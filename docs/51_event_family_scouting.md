...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_event_family_batch_catalog.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_event_price_association_readiness.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_cpi_inflation_association_readiness.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_event_family_remaining_acceptance.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_event_family_precondition_completion.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_event_family_empirical_coverage.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_event_family_all_association.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_event_family_threshold_grading.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_09_event_risk_governor/build_price_anomaly_event_discovery.py
```
