...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_batch_catalog.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_price_association_readiness.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_cpi_inflation_association_readiness.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_remaining_acceptance.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_precondition_completion.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_empirical_coverage.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_layer_final_judgment.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_all_association.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_impact_window_backtest.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_impact_window_real_input_backtest.py
```
...
```bash
PYTHONPATH=src /root/projects/trading-manager/.venv/bin/python scripts/models/model_10_event_risk_governor/build_event_family_impact_window_all_family_real_input_backtest.py
```
...
```bash
PYTHONPATH=src /root/projects/trading-manager/.venv/bin/python scripts/models/model_10_event_risk_governor/build_event_family_impact_window_replay.py \
...
- `layer_10_replay_input_rows.jsonl`
...
```bash
PYTHONPATH=src /root/projects/trading-manager/.venv/bin/python scripts/models/model_10_event_risk_governor/build_layer_10_fold_completion.py
```

Output artifacts live under `/root/projects/trading-storage/storage/03_model_artifacts/layer_10_fold_completion_20260610/fold_2016-01_2016-06/model_group_replay_20260609T060059Z/`:

- `layer_10_fold_completion_summary.json`
- `layer_10_fold_completion.json`
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_event_family_threshold_grading.py
```
...
```bash
PYTHONPATH=src python3 scripts/models/model_10_event_risk_governor/build_price_anomaly_event_discovery.py
```
