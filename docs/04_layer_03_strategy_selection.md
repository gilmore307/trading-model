...
|---|---:|---:|---|
| `moving_average_crossover` | 90-120 | 500 | fixed 1Min signal bars, sparse MA window profiles with a long endpoint, MA type, confirmation bars, minimum slope; no embedded trend filter. |
